...
# def CollisionCheck1(nextPoint, obstacleList):
...
if __name__ == '__main__':
    ...
    robotRadius =100
    # obstacleList = [
    #     (-1499.08, 1120,robotRadius),
    #     (-1499.08,0,robotRadius),  
    #     (-549.08, 0, robotRadius),
    #     (-2499.08, 0, robotRadius),
    #     (-3599.08, 0, robotRadius),
    #     (-3199.08, 750, robotRadius),
    #     (1499.08, 1120,robotRadius),
    #     (1499.08,0,robotRadius),  
    #     (549.08, 0, robotRadius),
    #     (2499.08, 0, robotRadius),
    ...
    print(rrt_instance1.update(start=(1497.67, 1.66),goal=(-574,160),obstacleList=obstacleList))