...
import time
''''
commented by rulshid as we are shifted to ros we don't need socket connection
...
def gr_Commands_CB(msg):
    global T_INIT , pubB, pubY, bList, yList
    T_INIT = time.time()
    ...
    # rospy.loginfo(" Data is being sent to :- " + str(msg.id))
