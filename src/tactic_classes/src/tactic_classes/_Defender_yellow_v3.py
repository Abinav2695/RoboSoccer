...
class the_defender():
    ...
    def __init__(self,team=False,robotId=99):
        ...
        if(self.defenderTeam):
            ...
            self.homePosition=Vector2D(800,400)
#home pos for blue team
    ...
    def beliefdata_callback(self,beliefdata):
        ...
        if(self.moveToPoint.x==INV or self.moveToPoint.y==INV):
            ...
            if self.gtp_instance.needToReplanRRT(self.moveToPoint):
...
if __name__=='__main__':
    ...
    rospy.init_node("defenderYellow_versionTwo",anonymous=False)
    
    defender = the_defender()
    
    rospy.Subscriber("/belief_state_output_yellow",BeliefState,defender.beliefdata_callback,queue_size=2)
