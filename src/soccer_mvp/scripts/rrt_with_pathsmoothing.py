...
class RRT():
    ...
    def __init__(self, start, goal, obstacleList, randArea_x, randArea_y, expandDis=100.0, goalSampleRate=10, maxIter=500):
        """
        Setting Parameter
...
def main(obstacleList, start, goal):
    rrt = RRT(start=start, goal=goal,
              randArea_x=[-1675, 1675], randArea_y=[-1400, 1400], obstacleList=obstacleList)
